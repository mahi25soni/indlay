        ...
        <div className="absolute right-0 top-0 z-1000 transform transition-transform duration-500 ease-in-out">
            <div className='relative'>
                ...
                <div className="max-h-[816px] w-[600px] bg-white p-[19px] flex flex-col  gap-5 overflow-auto scrollbar-hidden">
                    ...
                    <div className='h-[46px] w-full flex justify-between'>
                        <div className='flex flex-col h-full justify-between gap-2'>
                            <div className='font-medium text-xl leading-[22.4px]'>{data?.property?.name}</div>
                            <div className='text-light-gray font-normal leading-[15.68px]'>{data?.property?.address}</div>
                        </div>
                    ...
                    <div className='flex flex-col gap-3 w-full items-start'>
                        ...
                        <div className={`font-normal text-sm leading-[15.68px] text-light-gray ${readMoreActive ? "" : "line-clamp-3"}`}>
                            {tempDesc}
                        </div>
