...
const EachPropert = dynamic(() => import("@/app/listing/eachPropert"));
...
const Property = (data: VerticalPropertyProps) => {
  const [showEachProperty, setShowEachProperty] = useState(false);

  const handleCompareClick = () => {
    setShowEachProperty(true); // Show EachPropert component
  };
    ...
    <div className="relative flex min-w-[312px] flex-grow flex-col rounded-20 border border-basic bg-secondary">
      ...
      <div className="flex items-center gap-3 p-4">
        <button
          ...
          className="flex flex-1 items-center justify-center gap-3 rounded-70 border border-cta bg-cta py-2 text-secondary"
        >
